...
class ReviewManager {
    ...
    async speak(text) {
        try {
            ...
            // 创建音频元素
            const audio = document.getElementById('typingAudioPlayer') || document.createElement('audio');
            audio.id = 'typingAudioPlayer';
            
            if (!document.getElementById('typingAudioPlayer')) {
